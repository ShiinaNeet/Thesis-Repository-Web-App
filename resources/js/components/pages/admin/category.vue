<template>
    <div class="mx-5 mb-2 my-5 px-2.5 pb-2.5 bg-white rounded">
        ...
        no-data-html="No Category(s) to show"
        :filter="filter"
        ...
        >
            ...
            <template #bodyAppend>
                <tr v-if="$root.tblPagination(keywordList)">
                    <td
                    id="pagination"
                    ...
                    >
                        <div class="flex pt-[10px] select-none">
                            ...
                            :pages="filter == '' ? $root.tblPagination(keywordList) : (pages, $root.config.tblCurrPage = 1)"
                            input
                            />
                        </div>
                    </td>
        ...
        insertUpdateKeyword(method) {
            if (method !== 'create' || method !== 'save') {
                axios({
                    ...
                    if (resDataError.filter(key => key == 'category').length) {
